...
class AppColors {
  ...
  static const Color progressbarBackgroundColor = Color(
    0xFF364153,
  ); // Softer blue for a modern touch
  static const Color dotsColor = Color(
    0xFF4A5565,
  ); // Softer blue for a modern touch
  ...
  static const Gradient linearGradient = LinearGradient(
    ...
    colors: [Color(0xFF213043), Color(0xFF1A2634)],
  );
  // Text Colors
  ...
  static const Color defaultBorder = Color(0xFF454F5B);
